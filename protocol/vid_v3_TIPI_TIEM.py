...
EventTable={
    ...
    TrShiftReq: {'report':[SV_VehicleID, SV_TransferPort, SV_CarrierID,SV_CommandID,SV_ExecuteTime]},
...
AlarmTable={
    ...
    10007: {'report':[SV_ALTX, SV_ALSV, SV_UnitType, SV_UnitID, SV_Level, SV_SubCode, SV_VehicleID, SV_CommandID, SV_PortID], 'text':'Robot E84 interlock error'},
