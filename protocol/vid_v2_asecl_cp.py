...
EventTable={
    ...
    VehicleArrived: {'report':[SV_VehicleID, SV_TransferPort, SV_ResultCode]},

    VehicleAcquireStarted: {'report':[SV_VehicleID, SV_TransferPort, SV_CarrierID]},

    VehicleAcquireCompleted: {'report':[SV_VehicleID, SV_TransferPort, SV_CarrierID, SV_ResultCode]},

    VehicleAssigned: {'report':[SV_VehicleID, SV_CommandIDList]},

    VehicleDeparted: {'report':[SV_VehicleID, SV_TransferPort]},

    VehicleDepositStarted: {'report':[SV_VehicleID, SV_TransferPort, SV_CarrierID]},

    VehicleDepositCompleted: {'report':[SV_VehicleID, SV_TransferPort, SV_CarrierID, SV_ResultCode]},
    ...
    PortStatusUpdate: {'report':[SV_RackID, SV_SlotID, SV_SlotStatus, SV_SendBy, SV_RackLocation, SV_RackGroup]},
