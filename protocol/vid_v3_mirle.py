...
SV_ActiveCarriers=510
SV_EnhancedCarriers=51
SV_ActiveTransfers=13
SV_ActiveVehicles=53
#SV_TransferCommand=66 # [TransferInfo, CarrierLoc]*n
SV_TransferCompleteInfo=77 # [TransferInfo, CarrierLoc]*n
...
SV_VehicleID=70
SV_CarrierID=54
SV_EnhancedCarrierInfo=10
#SV_CarrierInfo=55
SV_CarrierLoc=56
SV_PortID=68
#SV_CurrentPortStates=76 #chocp 0528
SV_TransferState=722
#SV_CommandName=57
SV_CommandType=80
SV_SourcePort=65
SV_DestPort=60
...
SV_EnhancedCarrierInfo=10 #2024/06/21 for Mirle MCS
SV_InstallTime=12 #2024/06/21 for Mirle MCS
SV_CarrierState=203 #2024/06/21 for Mirle MCS
SV_BatteryValue=101
SV_VehicleLastPosition=102
SV_NearPort=120 #2024/08/02 for Mirle MCS
...
VehicleAssigned=201
VehicleDeparted=205
VehicleDepositStarted=207
VehicleDepositCompleted=208
VehicleInstalled=210
VehicleRemoved=211
VehicleUnassigned=202

VehicleChargeStarted=212
VehicleChargeCompleted=213
VehicleExchangeStarted=214
VehicleExchangeCompleted=215
...
EventTable={
    ...
    LoadBackOrder: {'report':[SV_CommandIDList]},
...
AlarmTable={
    # ALID: {'event_id':[set,clear], 'report_id':[], 'report':[], 'text':ALTX},
