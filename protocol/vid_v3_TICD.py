...
EventTable={
    ...
    TransferAbortCompleted: {'report':[SV_CommandID, SV_VehicleID, SV_TransferCompleteInfo]},
    ...
    TransferCompleted: {'report':[SV_CommandInfo, SV_TransferCompleteInfo, SV_VehicleID, SV_ResultCode]},
    TransferInitiated: {'report':[SV_CommandID]},
    TransferPaused: {'report':[SV_CommandID]},
    TransferResumed: {'report':[SV_CommandID]},
    Transferring: {'report':[SV_CommandID,SV_VehicleID]},
    VehicleStateChange: {'report':[SV_VehicleID, SV_VehicleState, SV_VehicleLastState]},
    VehicleArrived: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort, SV_ResultCode,SV_BatteryValue]},

    VehicleAcquireStarted: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort, SV_CarrierID,SV_BatteryValue]},

    VehicleAcquireCompleted: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort, SV_CarrierID, SV_ResultCode,SV_BatteryValue]},

    VehicleAssigned: {'report':[SV_VehicleID, SV_CommandIDList,SV_BatteryValue]},
    #VehicleAssigned: {'report':[SV_VehicleID, SV_CommandIDList]},

    VehicleDeparted: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort,SV_BatteryValue]},

    VehicleDepositStarted: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort, SV_CarrierID,SV_BatteryValue]},

    VehicleDepositCompleted: {'report':[SV_VehicleID, SV_CommandID, SV_TransferPort, SV_CarrierID, SV_ResultCode,SV_BatteryValue]},
    ...
    VehicleUnassigned: {'report':[SV_VehicleID, SV_CommandIDList,SV_BatteryValue]},
